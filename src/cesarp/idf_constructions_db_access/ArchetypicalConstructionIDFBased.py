...
class ArchetypicalConstructionIDFBased:
    def __init__(
        self,
        ...
        wall_constr_options,
        wall_constr_default,
        internal_ceiling_constr,
        external_constr_materials_idf,
        internal_constr_materials_idf,
        glazing_ratio_min,
        glazing_ratio_max,
        infiltration_rate,
        ...
        self.__check_is_fraction(glazing_ratio_min, "glazing_ratio_min")
        self.__check_is_fraction(glazing_ratio_max, "glazing_ratio_max")
        ...
        self.internal_ceiling_constr = internal_ceiling_constr
        self.exterior_constr_materials_idf = external_constr_materials_idf
        self.internal_constr_materials_idf = internal_constr_materials_idf
        self.glazing_ratio = MinMaxValue(glazing_ratio_min, glazing_ratio_max)
    ...
    def get_window_construction(self):
        glass_constr = self.__get_window_glass_construction()
        return WindowConstruction(frame=self.window_frame_construction, glass=glass_constr, shade=self.window_shade_constr)

    def __get_window_glass_construction(self):
        """
        :return: object defining construction for the window glass
        """
        return ConstructionAsIDF(self.window_glass_constr.get_value(self.__random_selection), self.exterior_constr_materials_idf)

    def get_roof_construction(self):
        """
        :return: one roof construction element
        """
        return ConstructionAsIDF(self.roof_constr.get_value(self.__random_selection), self.exterior_constr_materials_idf)

    def get_groundfloor_construction(self):
        """
        :return: one groundfloor construction element
        """
        return ConstructionAsIDF(self.groundfloor_constr.get_value(self.__random_selection), self.exterior_constr_materials_idf)

    def get_wall_construction(self):
        """
        :return: one wall construction element
        """
        return ConstructionAsIDF(self.wall_constr.get_value(self.__random_selection), self.exterior_constr_materials_idf)
    ...
    def get_internal_ceiling_construction(self):
        return ConstructionAsIDF(self.internal_ceiling_constr, self.internal_constr_materials_idf)
